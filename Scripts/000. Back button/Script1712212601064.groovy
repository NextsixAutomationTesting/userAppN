...
Mobile.startApplication('C:\\Users\\Nextsix\\git\\katalon-agentapp\\userMapTesterV1Leo.apk', true)
...
'Click Search bar in Homepage (Buy)'
Mobile.tap(findTestObject('Object Repository/000.Back Button/android.widget.TextView -'), 0)
...
'Click Search bar in Homepage (Rent)'
